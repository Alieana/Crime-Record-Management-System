<%-- 
    Document   : viewUser
    Created on : Feb 1, 2021, 9:38:35 PM
...
<html>
    <head>
        ...
        <title>User List | Crime Record Management System</title>
        <style>
        *{
            margin: 0;
            padding: 0;
    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <table>
                <tr id="header2">
                    <th colspan="14"><h2>User List</h2></th>
                </tr>
                <tr id="header2">
                    <th>ID</th>
                    <th>Name</th>
            ...
            <%
                ...
                try{
                    ...
                    preparedStatement = conn.prepareStatement("select * from USERS inner join ROLES on USERS.ROLE_ID=ROLES.ROLE_ID");
            ...
            <tr>
                ...
                <td><%=resultSet.getString("USER_PASS")%></td>
                <td><%=resultSet.getString("USER_PHONE")%></td>
                <td><%=resultSet.getString("USER_ADD")%></td>
                <td><%=resultSet.getString("USER_CITY")%></td>
                <td><%=resultSet.getString("USER_STATE")%></td>
                <td><%=resultSet.getString("USER_POSTCODE")%></td>
                <td><%=resultSet.getString("ROLE_NUM")%></td>
            
                <td><a href="editUser.jsp?editUser_id=<%=resultSet.getInt("USER_ID")%>">Edit</a></td>
                <td><a href="deleteUser.jsp?deleteUser_id=<%=resultSet.getInt("USER_ID")%>">Delete</a></td>
            </tr>
            <%
                    }
            ...
            <tr>
                <td colspan="14">
                    <a href="registerUser.jsp"><button class="btn">Register New User</button></a>
                </td>
            </tr>
        </table>
    </body>
