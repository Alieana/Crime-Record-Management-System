<%-- 
    Document   : registerRole
    Created on : Feb 3, 2021, 12:16:46 AM
...
<html>
    <head>
        ...
        <title>Role Registration | Crime Record Management System</title>
        <style>
        *{
            margin: 0;
            padding: 0;
        ...
        <div class="wrapper">
            ...
            <div class="container">
                <form method="POST" action="RoleServlet">
                    <h3>Role Registration Form</h3><br>
                    <div class="form-group">
                        <label for="roleNum">Role Number</label>
                        <input type="text" name="roleNum" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label for="roleName">Role Name</label>
                        <input type="text" name="roleName" class="form-control" required>
                    </div>
                    <input type="submit" class="btn" value="Register Role">
                </form>
            </div>
        </div>
    </body>
